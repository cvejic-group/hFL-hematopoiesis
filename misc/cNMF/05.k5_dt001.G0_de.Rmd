---
title: "cnmf_hsc.k5_dt001.G0_de"
---

```{r knitr, include = FALSE}
DOCNAME <- "cnmf_hsc.k5_dt001.G0_de"
...
padding = 0.4
ggvenn(cmp_lst, set_name_size = 4, show_percentage = FALSE) +
...
compareList <- list(
  ...
  up = df_de_sig |> filter(beta > 0) |> pull(gene) |> UpdateSymbolList(verbose = FALSE) |> 
    ...
    pull(ENTREZID),
  # 2.62% of input gene IDs are fail to map
