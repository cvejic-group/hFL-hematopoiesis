...
```{r}
df_res <- readRDS(here::here("output", "HSC.dev_da_CpG", "HSC_dev_da_peak_CGcontent_anno.rds"))
head(df_res)
```
...
```{r}
se <- readRDS(here::here("output", "HSC.dev_da_monaLisa", "se.rds"))
se_df <- readRDS(here::here("output", "HSC.dev_da_monaLisa", "HSC_DA_peak_monaLisa_sig_TF.rds"))
seSel <- readRDS(here::here("output", "HSC.dev_da_monaLisa", "seSel.rds"))
seSel
```
...
```{r}
se2 <- readRDS(here::here("output", "HSC.dev_da_monaLisa", "se.sep_proximal_distal_limitedTF.rds"))
se2
```
...
```{r}
df_motif2gene <- readRDS(here::here("output", "HSC.dev_da_monaLisa", "df_motif2gene.rds"))
