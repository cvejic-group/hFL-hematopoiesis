...
ID_GROUP="early"
BWS_IN="${DIR_IN}/HSC_PCW5/mean/preds/HSC_PCW5_mean._chrombpnet_nobias.bw"
BW_OUT="${DIR_OUT}/HSC_${ID_GROUP}_mean._chrombpnet_nobias.bw"
...
## MIDDLE: PCW 6 - 10
ID_GROUP="middle"
BWS_IN=$(for i in {6..10}; do echo -n "${DIR_IN}/HSC_PCW${i}/mean/preds/HSC_PCW${i}_mean._chrombpnet_nobias.bw "; done)
BW_OUT="${DIR_OUT}/HSC_${ID_GROUP}_mean._chrombpnet_nobias.bw"

BG_SUM="${DIR_OUT}/tmp_pred_nobias${ID_GROUP}_sum.bedGraph"
BG_MEAN="${DIR_OUT}/tmp_pred_nobias${ID_GROUP}_mean.bedGraph"
...
# LATE: PCW 11 - 18
ID_GROUP="late"
BWS_IN=$(for i in {11..18}; do echo -n "${DIR_IN}/HSC_PCW${i}/mean/preds/HSC_PCW${i}_mean._chrombpnet_nobias.bw "; done)
BW_OUT="${DIR_OUT}/HSC_${ID_GROUP}_mean._chrombpnet_nobias.bw"
