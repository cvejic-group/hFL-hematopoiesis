...
ID_GROUP="early"
BWS_IN="${DIR_IN}/HSC_PCW5/mean/shap/HSC_PCW5_mean.counts_scores.bw"
BW_OUT="${DIR_OUT}/HSC_${ID_GROUP}_mean.counts_scores.bw"
...
## MIDDLE: PCW 6 - 10
ID_GROUP="middle"
BWS_IN=$(for i in {6..10}; do echo -n "${DIR_IN}/HSC_PCW${i}/mean/shap/HSC_PCW${i}_mean.counts_scores.bw "; done)
BW_OUT="${DIR_OUT}/HSC_${ID_GROUP}_mean.counts_scores.bw"

BG_SUM="${DIR_OUT}/tmp_${ID_GROUP}_sum.bedGraph"
BG_MEAN="${DIR_OUT}/tmp_${ID_GROUP}_mean.bedGraph"
...
# LATE: PCW 11 - 18
ID_GROUP="late"
BWS_IN=$(for i in {11..18}; do echo -n "${DIR_IN}/HSC_PCW${i}/mean/shap/HSC_PCW${i}_mean.counts_scores.bw "; done)
BW_OUT="${DIR_OUT}/HSC_${ID_GROUP}_mean.counts_scores.bw"
