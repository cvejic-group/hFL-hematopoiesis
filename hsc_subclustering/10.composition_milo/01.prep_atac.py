...
# input
adata = sc.read_h5ad('/work/DevM_analysis/01.annotation/11.subclustering/HSC/data/FL_atac_snapatac2.v01.h5ad')
...
atac.obs['anno_wnn_v5'] = atac.obs['anno_wnn_v5'].cat.remove_unused_categories()
